...
- **Coding-agent integrations** for Codex, Claude Code, OpenCode, and Grok, using the host's model and repository tools.
...
- **OpenWiki integrations:** run OpenWiki directly inside Codex, Claude Code, OpenCode, or Grok, using the coding agent's authenticated model and native repository tools while OpenWiki manages the documentation lifecycle.
...
openwiki integrations install <codex|claude|opencode|grok> [--project [path]]
openwiki integrations uninstall <codex|claude|opencode|grok> [--project [path]]
